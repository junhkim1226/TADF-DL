...
parser.add_argument("--desc_dim", help="dimension of fingerprint", type=int, default=200)
...
if __name__ == "__main__":
    ...
    test_dataset, test_dataloader = get_dataset_dataloader(
        test_file, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)
    ...
    with torch.no_grad():
        ...
        for i_batch, batch in enumerate(test_dataloader):
            ...
            x = test_feature_dict['desc'].float()
