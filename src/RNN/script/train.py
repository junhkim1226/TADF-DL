...
parser.add_argument("--whole_file", help="file for whole data", type=str, default="../data/total.txt")
...
if __name__ == "__main__":
    ...
    for epoch in range(args.num_epochs):
        ...
        for i_batch, batch in enumerate(train_dataloader):
            ...
            x = train_feature_dict['seq'].long()
            l = train_feature_dict['length'].float()
        ...
        for i_batch, batch in enumerate(val_dataloader):
            ...
            x = val_feature_dict['seq'].long()
            l = val_feature_dict['length'].float()
